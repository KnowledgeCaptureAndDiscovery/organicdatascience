...
//            result.suggestions = that.verifySuggestionsFormat(result.suggestions); original
            console.log(JSON.stringify(result));
            console.log(JSON.stringify(result.wtsuggest));
            console.log(JSON.stringify(result.wtsuggest.suggestions));
            result.suggestions = that.verifySuggestionsFormat(result.wtsuggest.suggestions);
